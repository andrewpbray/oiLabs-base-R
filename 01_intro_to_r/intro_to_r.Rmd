...
We will be typing up your lab report using R Markdown. This 
...
Before continuing, please replace the word *author* with your name. Then click 
...
- click on the green arrow at the top right of the code chunk in the R Markdown (Rmd) 
file, or
