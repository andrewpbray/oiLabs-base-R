...
We will be typing up the lab report using R Markdown. This 
allows you to complete your lab entirely in RStudio while ensuring the 
transparency and reproducibility of your analysis. To help get you started we are 
...
Click on **From Template** and select **Lab Report for OpenIntro Lab 1**.

This will open up a lab report in a new pane called the *editor*. All you 
...
Before continuing, please replace the word *Name* with your name. Then click 
on **Knit HTML** and you'll see your document in a new pop-up window.

Now that we have the lab report ready to go, on to the data!
...
1. What command would you use to extract just the counts of girls baptized? Try
    it! (OK, so you may have noticed that we've already provided the answer to
    this one in your lab report. Go ahead and click the **Knit HTML** button to
    generate your lab report and notice that it provides both the code and the
...
5.  How do these counts compare to Arbuthnot's? Are they on a similar scale?
