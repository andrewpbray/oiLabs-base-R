...
columns, just as it says next to the object in your environment. You can see 
...
over time. Remember, if you are going to use `qplot` as a standalone function 
you have to use assignment to save over your old version of the data frame. 
Otherwise, you can pipe together a series of data manipulations and then plot 
in one chain. 
