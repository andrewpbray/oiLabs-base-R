...
The special symbol `<-` performs an *assignment*, taking the 
...
mutate(arbuthnot, ratio = boys / girls)
```
...
mutate(arbuthnot, prop = boys / (boys + girls))
```
...
over time. Remember, you have to use assignment to save over your old version of the data frame. 
What do you see? Tip: If you use the up and down arrow keys, you can 
