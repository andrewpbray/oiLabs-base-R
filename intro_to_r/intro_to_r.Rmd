...
<br>
<center><img src="more/Rmd-from-template.png" width=400></center>
<br>
...
`5218` follows `[1]`, indicating that `5218` is the first entry in 
the vector. And if `[43]` starts a line, then that would mean the first number 
on that line would represent the 43<sup>rd</sup> entry in the vector.
...
The data come from a sequence of reports issued anually between 2002 and 2013. The citation is below is for 2002; remaining years follow a similar format.
