...
Grading the professor {#grading-the-professor .unnumbered}
---------------------
    ...
    *cls\_perc\_eval* percent of students in class who completed evaluation.
     *cls\_did\_eval* number of students in class who completed evaluation.
      *cls\_students* total number of students in class.
       ...
       *bty\_f1lower* beauty rating of professor from lower level female: (1) lowest - (10) highest.
       *bty\_f1upper* beauty rating of professor from upper level female: (1) lowest - (10) highest.
       *bty\_f2upper* beauty rating of professor from second upper level female: (1) lowest - (10) highest.
       *bty\_m1lower* beauty rating of professor from lower level male: (1) lowest - (10) highest.
       *bty\_m1upper* beauty rating of professor from upper level male: (1) lowest - (10) highest.
       *bty\_m2upper* beauty rating of professor from second upper level male: (1) lowest - (10) highest.
...
Exploring the data {#exploring-the-data .unnumbered}
------------------
...
Simple linear regression {#simple-linear-regression .unnumbered}
------------------------
...
Replot the scatterplot, but this time use the function `jitter()` on the
...
Multiple linear regression {#multiple-linear-regression .unnumbered}
--------------------------
...
```
  ...
  1. What is the equation of the line corresponding to males? (*Hint:* For
...
comes first alphabetically as a $0$.

  1. Create a new model called `m_bty_rank` with `gender` removed and
...
The search for the best model {#the-search-for-the-best-model .unnumbered}
-----------------------------
...
```
  ...
  1. Check your suspicions from the previous exercise. Include the model
...
variable was collinear with the other explanatory variables?
  ...
  4. Using backward-selection and p-value as the selection criterion,
determine the best model. You do not need to show all steps in your
answer, just the output for the final model. Also, write out the linear
model for predicting score based on the final model you settle on.

  5. Verify that the conditions for this model are reasonable using
diagnostic plots.
...
the conditions of linear regression?
  ...
  7. Based on your final model, describe the characteristics of a professor
and course at University of Texas at Austin that would be associated
with a high evaluation score.

  8. Would you be comfortable generalizing your conclusions to apply to
