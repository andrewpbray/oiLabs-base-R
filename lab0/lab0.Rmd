...
-   In what year did we see the most total number of births in the U.S.? You can refer to the help files or [Minimal R reference card](http://cran.r-project.org/web/packages/mosaic/vignettes/V1MinimalR.pdf) to find helpful commands.
