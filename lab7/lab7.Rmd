...
In addition to runs scored, there are seven traditionally used variables in the data set: at-bats, hits, home runs, batting average, strikeouts, stolen bases, and wins. (Though it's not necessary for this lab, if you'd like a refresher in the rules of baseball and a description of these statistics, visit [http://en.wikipedia.org/wiki/Baseball_rules](http://en.wikipedia.org/wiki/Baseball_rules) and [http://en.wikipedia.org/wiki/Baseball_statistics](http://en.wikipedia.org/wiki/Baseball_statistics)). There are also three newer variables: on-base percentage, slugging percentage, and on-base plus slugging.  For the first portion of the analysis we'll consider the seven traditional variables. At the end of the lab, you'll work with the newer variables on your own.
