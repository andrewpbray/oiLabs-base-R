...
1.  What type of plot would you use to display the relationship between
    ...
    look linear? If you knew a team's `at_bats`, would you be comfortable
...
3.  Using `plot_ss`, choose a line that does a good job of minimizing the
...
8.  Based on the plot in (1), does the constant variability condition
    appear to be met?

## On Your Own

-   Choose another traditional variable from `mlb11` that you think
...
-   What concepts from the textbook are covered in this lab? What
