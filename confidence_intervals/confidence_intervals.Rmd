...
in handy here (If you are unfamiliar with loops, review the [Sampling Distribution Lab](http://htmlpreview.github.io/?https://github.com/andrewpbray/oiLabs-dplyr-ggplot/blob/master/sampling_distributions/sampling_distributions.html)).
...
-   Use the `plot_ci` function above to 
