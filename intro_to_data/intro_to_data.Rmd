...
Notice what we've done here! We've computed the table of `cdc$smoke100` and 
...
We could have accomplished this in two steps by saving the table in one line 
and applying `mosaicplot` in the next (see the `tally`/`barchart` example above).
