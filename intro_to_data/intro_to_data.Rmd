...
weight data is by using the `select` command. `select` is in the [`dplyr` package](https://cran.r-project.org/web/packages/dplyr/index.html), 
...
box plots of these values, defining groups by the variable `genhlth`.
