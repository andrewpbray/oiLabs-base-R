...
### Lab report
To create a reproducible lab report, 

1. Update title and author
2. Load in relevant data
3. Add a new exercise by typing in the new exercise number after ###
4. Add a new R chunk by clicking the green plus C button in the top right of the editor.
