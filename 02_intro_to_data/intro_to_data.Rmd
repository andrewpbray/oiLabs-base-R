...
- Line 1: Take the `nycflights` data frame, `filter` for flights headed to LAX, and 
...
user defined, like `mean_dd`, `sd_dd`, `n`, and you could customize these names 
...
1. Which New York area airport would you choose to fly out of if you were heading
to Los Angeles and wanted to minimize departure delay?
