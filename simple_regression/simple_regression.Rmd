...
The function `plotModel` plots the linear model in the "data space". Here, 
the model `m1`, contains all the information needed to plot both the 
original data and the line that represents the model fit to that data. 
