...
x <- seq(-4,4,length=100)*sdFheight + meanFheight
hx <- dnorm(x,meanFheight,sdFheight)
xyplot(hx~x, type="l", ylim=c(0, 0.065), ylab="Density", xlab="hgt", panel = function(x, y, ...){
          panel.polygon(x,y, col="#0080ff" )
          panel.polygon(c(182,190, 190, 182), c(0,0,0.02, 0.02), col="white", border=NA)
           panel.abline(v=182)
          panel.xyplot(x,y, type="l", ylim=c(0.02,0.06))
          })
```
