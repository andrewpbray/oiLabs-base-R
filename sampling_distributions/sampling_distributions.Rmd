...
1.  To make sure you understand what the `resample` and `do` function do, try
...
```{r eval=FALSE}
densityplot(~mean, groups = sample_size, data = sampling_dist)
